...
impl DsyrsClient {
    ...
    pub async fn init(&mut self) -> Result<()> {
        ...
        self.write_register(registers::P00_CONTROL_MODE, self.config.control_mode.into()).await?;
        
        // Set direction (P00.01)
        self.write_register(registers::P00_DIRECTION, self.config.direction.into()).await?;
        
        // Set max speed (P00.07)
        self.write_register(registers::P00_MAX_SPEED, self.config.max_speed).await?;
        
        // Set rated current (P01.04) - unit is 0.01 A
        let rated_current = (self.config.rated_current * 100.0) as u16;
        self.write_register(registers::P01_RATED_CURRENT, rated_current).await?;
        
        // Set encoder type (P01.18)
        self.write_register(registers::P01_ENCODER_SELECTION, self.config.encoder_type.into()).await?;
    ...
    pub async fn set_control_mode(&mut self, mode: ControlMode) -> Result<()> {
        self.write_register(registers::P00_CONTROL_MODE, mode.into()).await
    }
    ...
    pub async fn set_direction(&mut self, direction: Direction) -> Result<()> {
        self.write_register(registers::P00_DIRECTION, direction.into()).await
    }
    ...
    pub async fn set_rigidity(&mut self, level: u8) -> Result<()> {
        ...
        self.write_register(registers::P00_RIGIDITY, level as u16).await
    }
    ...
    pub async fn set_inertia_ratio(&mut self, ratio: u16) -> Result<()> {
        ...
        self.write_register(registers::P00_INERTIA_RATIO, ratio).await
    }
    ...
    pub async fn set_brake_off_delay(&mut self, ms: u16) -> Result<()> {
        self.write_register(registers::P00_BRAKE_OFF_DELAY, ms).await
    }
    ...
    pub async fn set_rated_current(&mut self, current: f32) -> Result<()> {
        ...
        self.write_register(registers::P01_RATED_CURRENT, value).await
    }
    ...
    pub async fn set_rated_torque(&mut self, torque: f32) -> Result<()> {
        ...
        self.write_register(registers::P01_RATED_TORQUE, value).await
    }
    ...
    pub async fn set_pole_pairs(&mut self, pairs: u8) -> Result<()> {
        ...
        self.write_register(registers::P01_POLE_PAIRS, pairs as u16).await
    }

    /// Set encoder type (P01.18)
    pub async fn set_encoder_type(&mut self, encoder: EncoderType) -> Result<()> {
        self.write_register(registers::P01_ENCODER_SELECTION, encoder.into()).await
    }
    ...
    pub async fn set_speed_command(&mut self, rpm: i16) -> Result<()> {
        self.write_register(registers::P05_SPEED_COMMAND, rpm as u16).await
    }
    ...
    pub async fn set_forward_speed_limit(&mut self, rpm: u16) -> Result<()> {
        self.write_register(registers::P05_FORWARD_SPEED_LIMIT, rpm).await
    }

    /// Set backward speed limit (P05.09, 0-9000 rpm)
    pub async fn set_backward_speed_limit(&mut self, rpm: u16) -> Result<()> {
        self.write_register(registers::P05_BACKWARD_SPEED_LIMIT, rpm).await
    }
    ...
    pub async fn set_position_gain(&mut self, gain: u16) -> Result<()> {
        self.write_register(registers::P07_POSITION_GAIN1, gain).await
    }
    ...
    pub async fn set_speed_integral(&mut self, time: u16) -> Result<()> {
        self.write_register(registers::P07_SPEED_INTEGRAL1, time).await
    }
    ...
    pub async fn apply_gain_params(&mut self, params: &GainParams) -> Result<()> {
        ...
        self.write_register(registers::P07_SPEED_FILTER1, params.speed_filter).await
    }
    ...
    pub async fn set_comm_address(&mut self, address: u8) -> Result<()> {
        self.write_register(registers::P10_COMM_ADDRESS, address as u16).await
    }

    /// Set Modbus baud rate (P10.02)
    pub async fn set_baud_rate(&mut self, baud: BaudRate) -> Result<()> {
        self.write_register(registers::P10_MODBUS_BAUDRATE, baud.into()).await
    }

    /// Set Modbus data format (P10.03)
    pub async fn set_data_format(&mut self, format: DataFormat) -> Result<()> {
        self.write_register(registers::P10_MODBUS_FORMAT, format.into()).await
    }
    ...
    pub async fn apply_comm_config(&mut self, config: &CommConfig) -> Result<()> {
        ...
        self.write_register(registers::P10_RS485_ADDRESS_SOURCE, config.address_source.into()).await
    }
    ...
    pub async fn factory_reset(&mut self) -> Result<()> {
        self.write_register(registers::P11_SYSTEM_INIT, SystemInit::FactoryReset.into()).await
    }

    /// Clear fault record (P11.09)
    pub async fn clear_fault_record(&mut self) -> Result<()> {
        self.write_register(registers::P11_SYSTEM_INIT, SystemInit::ClearFaultRecord.into()).await
    }

    /// Reset absolute encoder (P11.06)
    pub async fn reset_encoder(&mut self, reset: EncoderReset) -> Result<()> {
        self.write_register(registers::P11_ENCODER_RESET, reset.into()).await
    }
    ...
    pub async fn set_multi_seg_mode(&mut self, mode: MultiSegOperationMode) -> Result<()> {
        self.write_register(registers::P13_OPERATION_MODE, mode.into()).await
    }
    ...
    pub async fn set_multi_seg_start(&mut self, segment: u8) -> Result<()> {
        ...
        self.write_register(registers::P13_START_SEGMENT, segment as u16).await
    }
    ...
    pub async fn set_multi_seg_end(&mut self, segment: u8) -> Result<()> {
        ...
        self.write_register(registers::P13_END_SEGMENT, segment as u16).await
    }

    /// Set multi-segment position mode (P13.05)
    pub async fn set_multi_seg_position_mode(&mut self, mode: MultiSegPositionMode) -> Result<()> {
        self.write_register(registers::P13_POSITION_MODE, mode.into()).await
    }
    ...
    pub async fn configure_segment(&mut self, config: &SegmentConfig) -> Result<()> {
        ...
        self.write_register(accel_reg, config.accel_decel_time).await?;
    ...
    pub async fn get_speed(&mut self) -> Result<i16> {
        let data = self.read_registers(registers::P18_SPEED_FEEDBACK, 1).await?;
        Ok(data[0] as i16)
    }
    ...
    pub async fn get_torque(&mut self) -> Result<f32> {
        let data = self.read_registers(registers::P18_INTERNAL_TORQUE, 1).await?;
    ...
    pub async fn get_electrical_angle(&mut self) -> Result<f32> {
        let data = self.read_registers(registers::P18_ELECTRICAL_ANGLE, 1).await?;
        Ok(data[0] as f32 * 0.1)
    }
    ...
    pub async fn get_status(&mut self) -> Result<ServoStatus> {
        Ok(ServoStatus {
            ...
            torque: self.read_registers(registers::P18_INTERNAL_TORQUE, 1).await?[0] as i16,
            ...
            electrical_angle: self.read_registers(registers::P18_ELECTRICAL_ANGLE, 1).await?[0],
        })
    }
    ...
    pub async fn get_software_version(&mut self) -> Result<u16> {
        let data = self.read_registers(registers::P12_SOFTWARE_VERSION, 1).await?;
        Ok(data[0])
    }
